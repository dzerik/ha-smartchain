...
В нём предлагаются шесть встроенных инструментов (с пометкой «встроенный») рядом со всеми
вашими и MCP-инструментами, и поле показывается независимо от того, есть ли у вас свои
инструменты вообще:
